...
object RepositoryModule {
    ...
    @Provides
    @Singleton
    fun provideLoginRepository(service : LogInService,helper : HandleResponse) : LogInRepository{
        return LogInRepositoryImpl(logInService = service, handleResponse = helper)
    }
